...
function sendVerificationEmail($receiverEmail, $receiverName, $token) {
    ...
    try {
        ...
        $verifyLink = "http://localhost/Project_Development_Workshop/login_register/verifyEmail.php?token=" . $token;
...
function sendChangePasswordEmail($receiverEmail, $receiverName, $token) {
    ...
    try {
        ...
        $verifyLink = "http://localhost/Project_Development_Workshop/shared/verifyChangePassword.php?token=" . $token;
...
function sendForgotPasswordEmail($receiverEmail, $receiverName, $token) {
    ...
    try {
        ...
        $resetLink = "http://localhost/Project_Development_Workshop/login_register/resetPassword.php?token=" . $token;
